...
public class CustomerDAOTest {
	...
	public void testCreateCustomer() {
		...
		customer.setEmail("rabiaakar@gmail.com");
		customer.setFullname("Rabia Akar");
		customer.setCity("Ankara");
		customer.setCountry("Türkiye");
		customer.setAddress("Kurtalan Caddesi Hancý Sokak Þeker Apartmaný No:9 Daire:12");
		customer.setPassword("ýýýýýýý");
		customer.setPhone("05347558124");
